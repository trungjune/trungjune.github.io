...
var cards = [
  {
    title: "Profile",
    width: 280,
    html: `<div class="profile-image"><img src="${imagePath}/selfie.jpg" alt="Trung June"></div>
		<div class="profile-info">
			<table>
				<tbody>
					<tr><td>Name</td><td>Trung June</td></tr>
					...
					<tr><td>Portfolio</td><td><a href="https://trungjune-portfolio.netlify.app" target="_blank">View Now</a></td></tr>
					<tr><td>Portfolio MacOs</td><td><a href="https://trungjune-macos.netlify.app" target="_blank">View Now</a></td></tr>
					<tr><td>Portfolio Ubuntu</td><td><a href="https://trungjune-ubuntu.netlify.app/" target="_blank">View Now</a></td></tr>
					<tr>
            <td>Contact</td>
            <td>
              <a href="mailto:trinhhoangtrung194@gmail.com"><i class="fas fa-envelope"></i></a>
              <a href="https://join.skype.com/invite/fQzXZbuXfgqF"><i class="fab fa-skype"></i></a>
              <a href="https://t.me/trungjune"><i class="fab fa-telegram"></i></a>
              <a href="https://github.com/trungjune" target="_blank"><i class="fab fa-github"></i></a>
            </td>
          </tr>
				</tbody>
			</table>
  ...
  },
  {
    ...
    html: `<div class="face-capture-image">
			<img src="${imagePath}/face-capture.jpg" alt="Trung June Facial Recognition">
  ...
  },
  {
    ...
    width: 200,
    html: `
			<div class="vn-map-wrap">
				<img class="vn-map" src="${imagePath}/vn-map.svg" alt="Viet Nam Map">
  ...
  },
  {
    ...
    html: `
			<table>
				<tbody>
					<tr><td><a target="_blank" href="https://fptsoftware.com/">FPT Software</a></td><td>Ha Noi, Viet Nam</td><td>06/2018 - 12/2020</td><td><a href="#" onclick="modal(event)" data-title="FPT Software">Full Report</a></td></tr>
					<tr><td><a target="_blank" href="https://www.misa.vn/">Misa</a></td><td>Ha Noi, Viet Nam</td><td>01/2021 - 06/2022</td><td><a href="#" onclick="modal(event)" data-title="Misa">Full Report</a></td></tr>
					<tr><td><a target="_blank" href="https://vnpt-technology.vn/">VNPT Technology</a></td><td>Ha Noi, Viet Nam</td><td>06/2022 - Now</td><td><a href="#" onclick="modal(event)" data-title="Full Report">Full Report</a></td></tr>
				</tbody>
			</table>
		`,
  },
  {
    ...
    html: `<table>
			<tbody>
				<tr>
          <td>University of Transportation Technology</td>
          <td>2014-2018</td>
  ...
  },
  {
    ...
    html: `<table>
        ...
        <tr><td>JavaScript</td><td>Go</td></tr>
				...
				<tr><td>Rust</td><td>Dart</td></tr>
				<tr><td>Move</td><td>SQL</td></tr>
			</tbody>
		</table>`,
  },
  {
...
if (window.location.pathname === "/") {
  new Terminal({
    ...
    commands: [
      {
        text: 'load profile -firstName "Trung" -lastName "June"',
        typing: true,
      },
      {
        text: "loading...",
